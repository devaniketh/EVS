...
/**
 * @title DeployFlowEVM
 * @dev Deployment script for Flow EVM network
 */
contract DeployFlowEVM is Script {
    function run() external {
        uint256 deployerPrivateKey = vm.envUint("PRIVATE_KEY");
        address deployer = vm.addr(deployerPrivateKey);
        
        console.log("Deploying Subway Surfers Game to Flow EVM with account:", deployer);
        ...
        console.log("Set game contract for vault");
        ...
        console.log("Deployment completed successfully on Flow EVM!");
        ...
        // Flow EVM specific information
        console.log("\nFlow EVM Integration:");
        console.log("Contract addresses are compatible with Flow EVM");
        console.log("Use Flow EVM RPC endpoints for interaction");
        console.log("Consider using Flow's sponsored transactions for gasless interactions");
    }
}
